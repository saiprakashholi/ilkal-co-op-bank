  ...
  template: `
    <div class="panel-grid">
      ...
      <div class="panel-content">
        ...
        <ul>
          <li><a routerLink="/agri/schemes">Corporate 1</a></li>
          <li><a routerLink="/agri/short-term">Corporate 2</a></li>
          <li><a routerLink="/agri/faqs">Corporate 3</a></li>
        </ul>
      </div>
    </div>
  `,
...
export class CorporatePanelComponent {}
